...
export const Tags: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M9 5H2v7l6.29 6.29c.94.94 2.48.94 3.42 0l3.58-3.58c.94-.94.94-2.48 0-3.42L9 5Z"/><path d="M6 9.01V9"/><path d="m15 5 6.3 6.3a2.69 2.69 0 0 1 0 3.79L14.3 22a2.69 2.69 0 0 1-3.79 0L3 14.7V9a2 2 0 0 1 2-2h4l4-4Z"/></svg>
);
...
export const Car: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M14 16.5 19 12l-1.4-1.4a2 2 0 0 0-2.82 0L12 13.2V9.8a2 2 0 0 0-2-2H4.8a2 2 0 0 0-2 2v6.4a2 2 0 0 0 2 2h5.2a2 2 0 0 0 2-2Z"/><path d="M7 19h10"/><circle cx="7" cy="19" r="2"/><circle cx="17" cy="19" r="2"/></svg>
);

export const HeartPulse: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/><path d="M3.22 12H9.5l.7-1 2.1 4.4 1.4-2.2 1.1 1.8H21"/></svg>
);

export const FerrisWheel: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="2"/><path d="M12 2v4"/><path d="m6.8 4.2 2.8 2.8"/><path d="M4.2 6.8 7 9.6"/><path d="M2 12h4"/><path d="m4.2 17.2 2.8-2.8"/><path d="M6.8 19.8 9.6 17"/><path d="M12 22v-4"/><path d="m17.2 19.8-2.8-2.8"/><path d="M19.8 17.2 17 14.4"/><path d="M22 12h-4"/><path d="m19.8 6.8-2.8 2.8"/><path d="M17.2 4.2 14.4 7"/><path d="M12 12 6.3 5.1"/><path d="M12 12 5.1 17.7"/><path d="m12 12 6.9 6.9"/><path d="M12 12 17.7 5.1"/></svg>
);
